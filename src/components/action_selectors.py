...
class EpsilonGreedyActionSelector():
    ...
    def select_worse_action(self, agent_inputs, avail_actions, t_env, test_mode=False):
        self.epsilon = self.schedule.eval(t_env)
        ...
        picked_actions = masked_q_values.min(dim=2)[1]

        return picked_actions

    def select_best_action(self, agent_inputs, avail_actions, t_env, test_mode=False):
        self.epsilon = self.schedule.eval(t_env)
